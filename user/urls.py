...
from .views import UserRegisterViewSet, UserRoleUpdateViewSet, UserFromAccessTokenAPIView
...
urlpatterns = [
    ...
    path('from-token/', UserFromAccessTokenAPIView.as_view(), name='from-token'),
]
